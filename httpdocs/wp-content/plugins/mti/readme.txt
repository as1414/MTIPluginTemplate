=== MTI WooCommerce Quantity Controls ===
Contributors: MTI Business Solutions
Tags: woocommerce,ajax,cart,update,quantity,auto-update,refresh,qty,basket,notices
Donate link: https://www.paypal.me/mtisolutions/usd
...
? A light plugin that helps control the way item quantities are managed in woo commerce. Removes the default "Update cart" button. Optionally turns off cart page notices.
